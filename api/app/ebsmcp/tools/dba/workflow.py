...
(older releases used OWF_MGR; R12 bundles it under APPLSYS, reached
through APPS like every other product schema) — confirm this against the
target release before relying on
this in production.
"""
